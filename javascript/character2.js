function cowboy() {
  alert(
    "Laika finalmente irá partir para o além mundo! localizado em uma galaxia distante e com seu céu coberto por inúmeras camadas de nuvens."
  );
  alert(
  ...
  if (anakanEscolha === "B") {
    ...
    if (
      (anakanEscolha2 != "A" && anakanEscolha2 != "B") ||
      anakanEscolha2 === ""
    ) {
      alert("Atenção! Você deve escolher entre A ou B.");
      var anakanEscolha2 = prompt(
    ...
    if (anakanEscolha2 === "A") {
      ...
      if (
        (anakanEscolha3 != "A" && anakanEscolha3 != "B") ||
        anakanEscolha3 === ""
      ) {
        alert("Atenção! Você deve escolher entre A ou B.");
        var anakanEscolha3 = prompt(
